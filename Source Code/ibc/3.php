          ...
          <section class="wrapper site-min-height">
              ...
              <div class="row">
              	<?php 
			    	...
			    	//Videos Caller
					if(isset($_POST['submit_secondleft'])){
						if($_FILES['secondleft']['name'][0] != ''){
							$noti = updateAdVideos($_FILES['secondleft'], 'second-left', $connect, $_POST['edit']);
							echo $noti;
						}

						$id_tem = $_POST['edit'];
						$qry_currvol = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-left' AND `template_id` = '$id_tem'");
						$row_cvol = mysqli_fetch_array($qry_currvol);

						if($row_cvol['volume'] != $_POST['sec_vlme']){
							updateVolume($_POST['sec_vlme'], 'second-left', $connect, $_POST['edit']);
						}

						if(isset($_POST['vid_id'])){
							updateSched($connect, $_POST['vid_id'], $_POST['show_from'], $_POST['show_to'], 'second-left', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id'])){
							updateSched($connect, $_POST['inacvid_id'], $_POST['inacshow_from'], $_POST['inacshow_to'], 'second-left', $_POST['edit']);
						}
					}

					if(isset($_POST['submit_secondright'])){

						if($_FILES['secondright']['name'][0] != ''){
							$noti = updateAdVideos($_FILES['secondright'], 'second-right', $connect, $_POST['edit']);
							echo $noti;
						}

						$id_tem = $_POST['edit'];
						$qry_currvol = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-right' AND `template_id` = '$id_tem'");
						$row_cvol = mysqli_fetch_array($qry_currvol);

						if($row_cvol['volume'] != $_POST['sec_vlme2']){
							updateVolume($_POST['sec_vlme2'], 'second-right', $connect, $_POST['edit']);
						}

						if(isset($_POST['vid_id2'])){
							updateSched($connect, $_POST['vid_id2'], $_POST['show_from2'], $_POST['show_to2'], 'second-right', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id2'])){
							updateSched($connect, $_POST['inacvid_id2'], $_POST['inacshow_from2'], $_POST['inacshow_to2'], 'second-right', $_POST['edit']);
						}
					}
					...
					if(isset($_POST['submit_slide'])){
						$noti = updateSlider($_FILES['mainslide'], 'main-slide', $connect, $_POST['edit']);
						echo $noti;

						if(isset($_POST['vid_id3'])){
							updateSched($connect, $_POST['vid_id3'], $_POST['show_from3'], $_POST['show_to3'], 'main-slide', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id3'])){
							updateSched($connect, $_POST['inacvid_id3'], $_POST['inacshow_from3'], $_POST['inacshow_to3'], 'main-slide', $_POST['edit']);
						}
					}
					//end Slide Caller
				?>
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-left', $connect, 3); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-mid', $connect, 3); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-right', $connect, 3); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
              ...
              <div class="row">
				<div class="col-lg-12">
				  <section class="panel" style="height: 240px;">
					<div class="panel-body">
					  <p class="text-center" style="font-weight: bold;">Main - Slider<br>
					  <?php $get_btn = knowActionMain('main-slide', $connect, 3, 'image(s)'); echo $get_btn[3]; ?>
					  </p>
					  <p class="text-center">
						<button class="<?php echo $get_btn[0]; ?>" href="#main-slide" data-toggle="modal"><i class="<?php echo $get_btn[1]; ?>"></i> <?php echo $get_btn[2]; ?></button>
					  </p>
					</div>
				  </section>
				</div>
			...
			<div class="row">
				<div class="col-lg-6">
				  <section class="panel" style="height: 240px;">
					<div class="panel-body">
					  <p class="text-center" style="font-weight: bold;">Secondary - Left<br>
					  <?php $get_btn = knowActionMain('second-left', $connect, 3, 'video(s)'); echo $get_btn[3]; ?>
					  </p>
					  <p class="text-center">
						<button class="<?php echo $get_btn[0]; ?>" href="#second-left" data-toggle="modal"><i class="<?php echo $get_btn[1]; ?>"></i> <?php echo $get_btn[2]; ?></button>
					  </p>
					</div>
				  </section>
				</div>
                <div class="col-lg-6">
                  <section class="panel" style="height: 240px;">
                    <div class="panel-body">
                      <p class="text-center" style="font-weight: bold;">Secondary - Right<br>
                      <?php $get_btn = knowActionMain('second-right', $connect, 3, 'video(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                        <button class="<?php echo $get_btn[0]; ?>" href="#second-right" data-toggle="modal"><i class="<?php echo $get_btn[1]; ?>"></i> <?php echo $get_btn[2]; ?></button>
                      </p>
                    </div>
                  </section>
                </div>
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionScroller($connect, 3); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
...
<!--Modal-->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-left', $connect, 3);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
								...
								$input_class = 'exists';
								$img_prev = '<img src="upload/template_3/images/'.$get_input[4].'" alt="" />';
							  }
							  ?>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-mid', $connect, 3);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-right', $connect, 3);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
	...
	<!--Second Left Modal-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="second-left" class="modal fade">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Second Left Videos</h4>
						</div>
						<div class="modal-body">
							<?php

							  $query_volume = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-left' AND `template_id` = 3");
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="secondleft[]" multiple="multiple" accept=".mp4,.avi,.mkv,.flv,.mov"/>
									  </span>
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-left' AND `template_id` = 3");
									if ($query->num_rows > 0){
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-left' and template_id = 3 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-left' and template_id = 3 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<input type="hidden" id="edit" name="edit" value="3">
									<input type="submit" name="submit_secondleft" value="Submit" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
	...
	<!--Second Right Modal-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="second-right" class="modal fade">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Second Right Videos</h4>
						</div>
						<div class="modal-body">
						  <?php

						  $query_volume2 = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-right' AND `template_id` = 3");
						  ...
						  ?>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-new"><i class="icon-paper-clip"></i> Select file</span>
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="secondright[]" multiple="multiple" accept=".mp4,.avi,.mkv,.flv,.mov"/>
									  </span>
										<span class="fileupload-preview" style="margin-left:5px;"></span>
										<a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
									</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-right' AND `template_id` = 3");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
											  ...
											  <td>
												...
												<input type="hidden" id="edit" name="edit" value="3">
								  	  			<input type="hidden" name="vid-id" value="'.$row['id'].'"/>
												<button name="remove-vid" title="Remove Video" class="btn btn-danger btn-xs"><i class="icon-trash"></i></button>
												</form>
											  </td>
										  </tr>
										';
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<input type="hidden" id="edit" name="edit" value="3">
									<input type="submit" name="submit_secondright" value="Submit" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
	...
	<!--Main Slider Modal-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="main-slide" class="modal fade">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Main Slider</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-new"><i class="icon-paper-clip"></i> Select file</span>
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="mainslide[]" multiple="multiple" accept=".png,.jpeg,.jpg,.gif"/>
									  </span>
										<span class="fileupload-preview" style="margin-left:5px;"></span>
										<a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
									</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-slide' AND `template_id` = 3");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-slide' and template_id = 3 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
									  	$now = new DateTime($row['show_to']);
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-slide' and   template_id = 3 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<input type="hidden" id="edit" name="edit" value="3">
									<input type="submit" name="submit_slide" value="Submit" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
  ...
  <!--Slider Second Bottom-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="scroller-settings" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
				  <?php

				  $query_getscroll = mysqli_query($connect, "SELECT `marquee_text`, `font_type`, `font_color`, `font_size`, `scroll_speed` FROM `marquee` where `template_id` = 3");
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bg-settings" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          $query_bg = mysqli_query($connect, "SELECT `bg_color` FROM `background` where `template_id` = 3");
