          ...
          <section class="wrapper site-min-height">
              ...
              <div class="row">
				<?php 
			    	...
			    	//Videos Caller
					if(isset($_POST['submit_mainleft'])){
						if($_FILES['mainleft']['name'][0] != ''){
							$noti = updateAdVideos($_FILES['mainleft'], 'main-left', $connect, $_POST['edit']);
							echo $noti;
						}

						$id_tem = $_POST['edit'];
						$qry_currvol = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-left' AND `template_id` = '$id_tem'");
						$row_cvol = mysqli_fetch_array($qry_currvol);

						if($row_cvol['volume'] != $_POST['sec_vlme']){
							updateVolume($_POST['sec_vlme'], 'main-left', $connect, $_POST['edit']);
						}
					...
					if(isset($_POST['submit_mainright'])){

						if($_FILES['mainright']['name'][0] != ''){
							$noti = updateAdVideos($_FILES['mainright'], 'main-right', $connect, $_POST['edit']);
							echo $noti;
						}

						$id_tem = $_POST['edit'];
						$qry_currvol = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-right' AND `template_id` = '$id_tem'");
						$row_cvol = mysqli_fetch_array($qry_currvol);

						if($row_cvol['volume'] != $_POST['sec_vlme2']){
							updateVolume($_POST['sec_vlme2'], 'main-right', $connect, $_POST['edit']);
						}
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-left', $connect, 4); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-mid', $connect, 4); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-right', $connect, 4); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
				...
				<div class="col-lg-6">
				  <section class="panel" style="height: 500px;">
					<div class="panel-body">
					  ...
					  <?php $get_btn = knowActionMain('main-left', $connect, 4, 'video(s)'); echo $get_btn[3]; ?>
					  </p>
					  <p class="text-center">
                ...
                <div class="col-lg-6">
                  <section class="panel" style="height: 500px;">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionMain('main-right', $connect, 4, 'video(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionScroller($connect, 4); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-left', $connect, 4);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
								...
								$input_class = 'exists';
								$img_prev = '<img src="upload/template_4/images/'.$get_input[4].'" alt="" />';
							  }
							  ?>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-mid', $connect, 4);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-right', $connect, 4);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Main Left Videos</h4>
						</div>
						<div class="modal-body">
							<?php

							  $query_volume = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-left' AND `template_id` = 4");
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="mainleft[]" multiple="multiple" accept=".mp4,.avi,.mkv,.flv,.mov"/>
									  </span>
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-left' AND `template_id` = 4");
									if ($query->num_rows > 0){
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-left' and template_id = 4 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-left' and template_id = 4 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<input type="hidden" id="edit" name="edit" value="4">
									<input type="submit" name="submit_mainleft" value="Submit" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Main Right Videos</h4>
						</div>
						<div class="modal-body">
						  <?php

						  $query_volume2 = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-right' AND `template_id` = 4");
						  ...
						  ?>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-new"><i class="icon-paper-clip"></i> Select file</span>
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="mainright[]" multiple="multiple" accept=".mp4,.avi,.mkv,.flv,.mov"/>
									  </span>
										<span class="fileupload-preview" style="margin-left:5px;"></span>
										<a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
									</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-right' AND `template_id` = 4");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-right' and template_id = 4 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
									  	$now = new DateTime($row['show_to']);
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-right' and template_id = 4 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<input type="hidden" id="edit" name="edit" value="4">
									<input type="submit" name="submit_mainright" value="Submit" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="scroller-settings" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
				  ...
				  $query_getscroll = mysqli_query($connect, "SELECT `marquee_text`, `font_type`, `font_color`, `font_size`, `scroll_speed` FROM `marquee` where `template_id` = 4");
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bg-settings" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          $query_bg = mysqli_query($connect, "SELECT `bg_color` FROM `background` where `template_id` = 4");
