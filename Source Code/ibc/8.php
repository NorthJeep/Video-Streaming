              ...
              <div class="row">
				<?php 
					...
					if(isset($_POST['submit_slide'])){
						$noti = updateSlider($_FILES['mainslide'], 'main-right', $connect, $_POST['edit']);
						echo $noti;
				...
				<div class="col-lg-6">
				  <section class="panel" style="height: 700px;">
					<div class="panel-body">
					  ...
					  <?php $get_btn = knowActionMain('main-left', $connect, 8, 'video(s)'); echo $get_btn[3]; ?>
					  </p>
					  <p class="text-center">
                ...
                <div class="col-lg-6">
                  <section class="panel" style="height: 700px;">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionMain('main-right', $connect, 8, 'image(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php
							  ...
							  $query_volume = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-left' AND `template_id` = 8");
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-left' AND `template_id` = 8");
									if ($query->num_rows > 0){
							...
							<div class="form-group">
				              ...
				              <div class="form-group">
				                ...
				                <div class="col-lg-10">
				                  ...
				                  $query = mysqli_query($connect, "select * from upload where location = 'main-left' and template_id = 8 and status = 0");
				                  if ($query->num_rows > 0){
				                    while($row = mysqli_fetch_array($query)){
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-right' AND `template_id` = 8");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-right' and template_id = 8 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bg-settings" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          $query_bg = mysqli_query($connect, "SELECT `bg_color` FROM `background` WHERE `template_id` = 8");
