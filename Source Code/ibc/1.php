      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="row">
					...
					if(isset($_POST['submit_sectop'])){

						if($_FILES['secondtop']['name'][0] != ''){
							$noti = updateAdVideos($_FILES['secondtop'], 'second-top', $connect, $_POST['edit']);
							echo $noti;
						}

						$id_tem = $_POST['edit'];
						$qry_currvol = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-top' AND `template_id` = '$id_tem'");
						$row_cvol = mysqli_fetch_array($qry_currvol);

						if($row_cvol['volume'] != $_POST['sec_vlme2']){
							updateVolume($_POST['sec_vlme2'], 'second-top', $connect, $_POST['edit']);
						}

						if(isset($_POST['vid_id2'])){
							updateSched($connect, $_POST['vid_id2'], $_POST['show_from2'], $_POST['show_to2'], 'second-top', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id2'])){
							updateSched($connect, $_POST['inacvid_id2'], $_POST['inacshow_from2'], $_POST['inacshow_to2'], 'second-top', $_POST['edit']);
						}
					}
					...
					if(isset($_POST['submit_slide'])){
						$noti = updateSlider($_FILES['secondbot'], 'second-bot', $connect, $_POST['edit']);
						echo $noti;

						if(isset($_POST['vid_id3'])){
							updateSched($connect, $_POST['vid_id3'], $_POST['show_from3'], $_POST['show_to3'], 'second-top', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id3'])){
							updateSched($connect, $_POST['inacvid_id3'], $_POST['inacshow_from3'], $_POST['inacshow_to3'], 'second-top', $_POST['edit']);
						}
					}
					//end Slide Caller
			    ?>
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-left', $connect, 1); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-mid', $connect, 1); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-right', $connect, 1); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
              ...
              <div class="row">
                <div class="col-lg-8">
                  <section class="panel" style="height: 500px;">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionMain('main-ad', $connect, 1, 'video(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel" style="height: 240px;">
                    <div class="panel-body">
                      <p class="text-center" style="font-weight: bold;">Secondary - Top<br>
                      <?php $get_btn = knowActionMain('second-top', $connect, 1, 'video(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                        <button class="<?php echo $get_btn[0]; ?>" href="#second-top" data-toggle="modal"><i class="<?php echo $get_btn[1]; ?>"></i> <?php echo $get_btn[2]; ?></button>
                      </p>
                    </div>
                  </section>
                </div>
                <div class="col-lg-4">
                  <section class="panel" style="height: 240px;">
                    <div class="panel-body">
                      <p class="text-center" style="font-weight: bold;">Secondary - Bottom<br>
                      <?php $get_btn = knowActionMain('second-bot', $connect, 1, 'images(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                        <button class="<?php echo $get_btn[0]; ?>" href="#second-bot" data-toggle="modal"><i class="<?php echo $get_btn[1]; ?>"></i> <?php echo $get_btn[2]; ?></button>
                      </p>
                    </div>
                  </section>
                </div>
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionScroller($connect, 1); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
...
<!--Modal-->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-left', $connect, 1);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
								...
								$input_class = 'exists';
								$img_prev = '<img src="upload/template_1/images/'.$get_input[4].'" alt="" />';
							  }
							  ?>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-mid', $connect, 1);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-right', $connect, 1);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php
							  ...
							  $query_volume = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-ad' AND `template_id` = 1");
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-ad' and   template_id = 1 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
						...
						<div class="modal-footer">
							<input type="hidden" id="edit" name="edit" value="1">
							<input type="submit" name="submit_mainad" value="Submit" class="btn btn-primary submit-med">
						</div>
					</div>
				</div>
			</form>
	...
	<!--Video Second Top-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="second-top" class="modal fade">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
							<h4 class="modal-title">Secondary Video</h4>
						</div>
						<div class="modal-body">
							  <?php

							  $query_volume2 = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-top' AND  `template_id` = 1");
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-new"><i class="icon-paper-clip"></i> Select file</span>
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="secondtop[]" multiple="multiple" accept=".mp4,.avi,.mkv,.flv,.mov"/>
									  </span>
										<span class="fileupload-preview" style="margin-left:5px;"></span>
										<a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
									</div>
									...
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										...
										echo '
										  <tr id="main_td">
											  <td>'.$row['name'].'</td>
											  <td>'.$date->diff($now)->format("%d days, %h hours and %i minutes <em>remaining</em>").'</td>
											  <td>
												<a name="set-vid" title="Set Time" class="btn btn-info btn-xs shet pull-right"><i class="icon-time"></i></a>
											  </td>
										  </tr>
										  <tr>
										  	<td colspan="3" style="padding: 0px 0px 7px 0px; border: none;">
											  	...
											  	<div class="col-xs-6"><span class="text-muted" style="font-size: 12px;">from</span> <input type="datetime-local" class="form-control in-from" name="show_from2[]" style="font-size: 11px;" '.$date1.' min="'.date('Y-m-d').'T00:00:00"></div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-top' and template_id = 1 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										...
										echo '
										  ...
										  <tr>
										  	<td colspan="2" style="padding: 0px 0px 7px 0px; border: none;">
										  		<input type="hidden" name="inacvid_id2[]" value="'.$row['id'].'"/>
											  	<div class="col-xs-6"><span class="text-muted" style="font-size: 12px;">from</span> <input type="datetime-local" class="form-control" name="inacshow_from2[]" style="font-size: 11px;" '.$date1.' min="'.date('Y-m-d').'T00:00:00"></div>
											  	<div class="col-xs-6"> <span class="text-muted" style="font-size: 12px;">to</span> <input type="datetime-local" class="form-control" name="inacshow_to2[]" style="font-size: 11px;" '.$date1.' min="'.date('Y-m-d').'T00:00:00"></div>
											</td>
										  </tr>
										';
									  }
						...
						<div class="modal-footer">
							<input type="hidden" id="edit" name="edit" value="1">
							<input type="submit" name="submit_sectop" value="Submit" class="btn btn-primary">
						</div>
					</div>
				</div>
			</form>
	...
	<!--Slider Second Bottom-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="second-bot" class="modal fade">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <span class="fileupload-new"><i class="icon-paper-clip"></i> Select file</span>
									  <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
									  <input type="file" class="default" name="secondbot[]" multiple="multiple" accept=".png,.jpeg,.jpg,.gif"/>
									  </span>
										<span class="fileupload-preview" style="margin-left:5px;"></span>
										<a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
									</div>
										...
										echo '
										  ...
										  <tr>
										  	<td colspan="3" style="padding: 0px 0px 7px 0px; border: none;">
											  	...
											  	<div class="col-xs-6"><span class="text-muted" style="font-size: 12px;">from</span> <input type="datetime-local" class="form-control in-from" name="show_from3[]" style="font-size: 11px;" '.$date1.' min="'.date('Y-m-d').'T00:00:00"></div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-bot' and template_id = 1 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										...
										echo '
										  ...
										  <tr>
										  	<td colspan="2" style="padding: 0px 0px 7px 0px; border: none;">
											  	...
											  	<div class="col-xs-6"><span class="text-muted" style="font-size: 12px;">from</span> <input type="datetime-local" class="form-control" name="inacshow_from3[]" style="font-size: 11px;" '.$date1.' min="'.date('Y-m-d').'T00:00:00"></div>
  ...
  <!--Text Scroller-->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="scroller-settings" class="modal fade">
          ...
          $query_getscroll = mysqli_query($connect, "SELECT `marquee_text`, `font_type`, `font_color`, `font_size`, `scroll_speed` FROM `marquee` WHERE template_id = 1");
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bg-settings" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          $query_bg = mysqli_query($connect, "SELECT `bg_color` FROM `background` WHERE `template_id` = 1");
