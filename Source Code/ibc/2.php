              	...
              	<?php 
					...
					if(isset($_POST['submit_slide'])){
						...
						if(isset($_POST['vid_id3'])){
							updateSched($connect, $_POST['vid_id3'], $_POST['show_from3'], $_POST['show_to3'], 'second-bot', $_POST['edit']);
						}

						if(isset($_POST['inacvid_id3'])){
							updateSched($connect, $_POST['inacvid_id3'], $_POST['inacshow_from3'], $_POST['inacshow_to3'], 'second-bot', $_POST['edit']);
						}
					}
					//end Slide Caller
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-left', $connect, 2); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-mid', $connect, 2); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-4">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionHeader('header-right', $connect, 2); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
					...
					<div class="col-lg-12">
					  <section class="panel" style="height: 240px;">
						<div class="panel-body">
						  ...
						  <?php $get_btn = knowActionMain('second-top', $connect, 2, 'video(s)'); echo $get_btn[3]; ?>
						  </p>
						  <p class="text-center">
					...
					<div class="col-lg-12">
					  <section class="panel" style="height: 240px;">
						<div class="panel-body">
						  ...
						  <?php $get_btn = knowActionMain('second-bot', $connect, 2, 'image(s)'); echo $get_btn[3]; ?>
						  </p>
						  <p class="text-center">
                ...
                <div class="col-lg-8">
                  <section class="panel" style="height: 500px;">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionMain('main-ad', $connect, 2, 'video(s)'); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <div class="panel-body">
                      ...
                      <?php $get_btn = knowActionScroller($connect, 2); echo $get_btn[3]; ?>
                      </p>
                      <p class="text-center">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-left', $connect, 2);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
								...
								$input_class = 'exists';
								$img_prev = '<img src="upload/template_2/images/'.$get_input[4].'" alt="" />';
							  }
							  ?>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-mid', $connect, 2);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
							  ...
							  <?php
							  $get_input = knowActionHeader('header-right', $connect, 2);
							  if($get_input[2] == 'Add'){
								$input_class = 'new';
								$img_prev = '';
							  }
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							$query_volume = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'main-ad' AND `template_id` = 2");
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-ad' AND `template_id` = 2");
									if ($query->num_rows > 0){
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-ad' and template_id = 2 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'main-ad' and   template_id = 2 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
						  ...
						  $query_volume2 = mysqli_query($connect, "SELECT * FROM `mute` WHERE `location` = 'second-top' AND `template_id` = 2");
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-top' AND `template_id` = 2");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-top' and template_id = 2 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
									  	$now = new DateTime($row['show_to']);
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-top' and   template_id = 2 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
							...
							<!-- <div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-bot' AND `template_id` = 2");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
										echo '
										  <tr>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-bot' and template_id = 2 and status = 1");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
									  	$date = new DateTime();
									  	$now = new DateTime($row['show_to']);
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								  <table class="table">
									...
									$query = mysqli_query($connect, "select * from upload where location = 'second-bot' and   template_id = 2 and status = 0");
									if ($query->num_rows > 0){
									  while($row = mysqli_fetch_array($query)){
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="scroller-settings" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
				  ...
				  $query_getscroll = mysqli_query($connect, "SELECT `marquee_text`, `font_type`, `font_color`, `font_size`, `scroll_speed` FROM `marquee` where `template_id` = 2");
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bg-settings" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          $query_bg = mysqli_query($connect, "SELECT `bg_color` FROM `background` where `template_id` = 2");
